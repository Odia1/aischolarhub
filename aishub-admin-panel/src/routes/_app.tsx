  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <footer className="border-t border-(--cui-color-stroke-default) bg-(--cui-color-background-default) px-4 py-2 text-center text-xs text-(--cui-color-text-muted)">
          AI Scholar Hub • Conceived & Developed by Prof. Priyadarsan Patra
        </footer>
      </div>
